...
User.create(user_name:"Khaz" )

User.create(user_name:"Sai" )

User.create(user_name:"Karthik" )
...
Restaurant_Dish.create(restaurant_id: 1, dish_id: 1, avg_rating: 4)
Restaurant_Dish.create(restaurant_id: 2, dish_id: 1, avg_rating: 5)
Restaurant_Dish.create(restaurant_id: 3, dish_id: 1, avg_rating: 2)
Restaurant_Dish.create(restaurant_id: 4, dish_id: 2, avg_rating: 3)
Restaurant_Dish.create(restaurant_id: 5, dish_id: 2, avg_rating: 5)
Restaurant_Dish.create(restaurant_id: 6, dish_id: 2, avg_rating: 4)
Restaurant_Dish.create(restaurant_id: 7, dish_id: 3, avg_rating: 3)
Restaurant_Dish.create(restaurant_id: 8, dish_id: 3, avg_rating: 2)
Restaurant_Dish.create(restaurant_id: 9, dish_id: 3, avg_rating: 1)
Restaurant_Dish.create(restaurant_id: 10, dish_id: 4, avg_rating: 3)
Restaurant_Dish.create(restaurant_id: 11, dish_id: 4, avg_rating: 1)
Restaurant_Dish.create(restaurant_id: 12, dish_id: 4, avg_rating: 5)
Restaurant_Dish.create(restaurant_id: 13, dish_id: 5, avg_rating: 2)
Restaurant_Dish.create(restaurant_id: 14, dish_id: 5, avg_rating: 3)
Restaurant_Dish.create(restaurant_id: 15, dish_id: 5, avg_rating: 4)
Restaurant_Dish.create(restaurant_id: 16, dish_id: 6, avg_rating: 3)
Restaurant_Dish.create(restaurant_id: 17, dish_id: 6, avg_rating: 1)
Restaurant_Dish.create(restaurant_id: 18, dish_id: 6, avg_rating: 4)



Review.create( restaurant_dish_id: 1 ,user_id: 1,comments: "They have unique flavors", user_rating: "4")
Review.create( restaurant_dish_id: 1 ,user_id: 2,comments: "They have delicious toppings", user_rating: "3.9")
Review.create( restaurant_dish_id: 3 ,user_id: 3,comments: "The food is bad", user_rating: "1")
Review.create( restaurant_dish_id: 3 ,user_id: 2,comments: "The food is worst", user_rating: "2")
Review.create( restaurant_dish_id: 3 ,user_id: 1,comments: "The food is disgusting", user_rating: "3.2")
Review.create( restaurant_dish_id: 3 ,user_id: 3,comments: "The food is inedible", user_rating: "1")
